  ...
  const Page1 = () => {
    return (
      <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        {/* Enhanced animated stars with dynamic movement */}
        {/* <div className="absolute inset-0 z-0">
          {[...Array(15)].map((_, i) => (
            <div
              key={`star-${i}`}
              className="absolute h-1 w-1 bg-[#ffff33] rounded-full star"
              style={{
                top: `${Math.random() * 100}%`,
                left: `${Math.random() * 100}%`,
                animationDelay: `${Math.random() * 2}s`,
                boxShadow: '0 0 15px 3px rgba(255,255,51,0.8)',
        ...
        <div className="relative z-10 container mx-auto px-6 py-32 perspective-1000">
          ...
          <div className="flex justify-between items-center mb-40">
            ...
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#ffff33] to-yellow-500 overflow-hidden hover-scale relative group cursor-pointer">
              ...
              <img src={pic} alt="Profile" className="object-cover w-full h-full relative z-10 transform group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>

            {/* Navigation icons with glass morphism effect */}
            <div className="flex items-center gap-4 bg-[#ffff33] backdrop-blur-xl rounded-full px-8 py-4 border border-[#ffff33]/20 shadow-[0_0_20px_rgba(255,255,51,0.1)]">
              {[Home, Disc, Flame, FileText, Target, Phone].map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="p-3 bg-black rounded-full transition-all duration-300 nav-icon group relative overflow-hidden"
                >
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center mt-20">
            ...
            <div className="w-full md:w-1/2 space-y-8">
              <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight font-['Orbitron']">
                ...
                <br />
                <span className="inline-block animate-fade-in-up" style={{ animationDelay: '0.4s' }}>Innovations.</span>{" "}
              ...
              <p className="text-gray-300 max-w-lg text-lg font-['Orbitron'] leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
                Welcome to{" "}
              ...
              <button className="shimmer-button flex items-center gap-4 font-['Orbitron'] hover-scale group animate-fade-in-up" style={{ animationDelay: '1s' }}>
        ...
        <div className="fixed right-[4%] bottom-32 flex flex-col items-center gap-6 z-20">
          <a href="#" className="p-4 bg-[#ffff33] rounded-full hover:bg-yellow-400 transition-all duration-300 social-icon group shadow-[0_0_15px_rgba(255,255,51,0.3)]">
