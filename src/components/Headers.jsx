    ...
    <header className="fixed left-1/2 -translate-x-1/2 z-50 w-full  py-2">
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "ring-2 ring-white/20 shadow-[0_0_10px_rgba(255,255,51,0.8)]"
                          : ""
                      )}
      ...
      {isMobile && (
        ...
        >
          ...
          <div
            ref={menuRef}
            className={`absolute top-0 right-0 h-full w-3/4 max-w-xs bg-black/90 backdrop-blur-md p-4 transition-transform duration-300 ${
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "ring-2 ring-[#ffff33]/50 shadow-[0_0_10px_rgba(255,255,51,0.8)]"
                        : ""
                    )}
                  >
                    <div className="absolute inset-0 bg-gradient-to-br from-[#ffff33]/0 to-[#ffff33]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
