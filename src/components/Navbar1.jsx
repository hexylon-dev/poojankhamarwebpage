...
//       <header
//         className={`transition-all duration-500 ${isScrolled ? "mt-2" : "mt-2"
//           }`}
//       >
//         <nav
//           className={`mx-auto backdrop-blur-xl border md:rounded-full rounded-2xl bg-[#5E5E5E]/20  ${isScrolled
...
//                               to={`/${service.path}`}
//                               className={({ isActive }) =>
//                                 `flex items-center space-x-2 lg:px-2 px-1 py-2 text-lg rounded-lg ${isActive
...
//                               <span
//                                 className={({ isActive }) =>
//                                   `inline-block self-start ${isActive
//                                     ? "text-[#FF7A33] bg-[#FF7A33]/10"
//                                     : "text-white/70"
//                                   } hover:text-[#FF7A33] hover:bg-[#FF7A33]/10 transition-colors duration-200`
//                                 }
...
//                     to={`/${item.path}`}
//                     className={({ isActive }) =>
//                       `text-sm font-medium ${isActive ? "text-[#FF7A33]" : "text-white/70"
...
//                               to={`/${service.path}`}
//                               className={({ isActive }) =>
//                                 `flex items-center space-x-1 px-1 py-2 text-[1.1rem] rounded-lg ${isActive
//                                   ? "text-[#FF7A33] bg-[#FF7A33]/10"
//                                   : "text-white/70"
//                                 } hover:text-[#FF7A33] hover:bg-[#FF7A33]/10 transition-colors duration-200`
//                               }
...
//                     to={`/${item.path}`}
//                     className={({ isActive }) =>
//                       `block font-medium ${isActive ? "text-[#FF7A33]" : "text-white/70"
//                       } hover:text-[#FF7A33] `
//                     }
