  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-black to-zinc-900 text-white font-sans">
      <div className="w-full max-w-7xl mx-auto px-4 py-16">
        ...
        {/* Bio Section */}
        <div className="mb-24 text-lg max-w-3xl mx-auto">
          <p className="mb-8 leading-relaxed text-gray-400">
            I'm <span className="font-bold text-[#ffff33]">Poojan Khamar</span>, a relentless innovator, creative leader, and
            futurist who believes in building beyond boundaries. Every success, every failure, every rise and fall has
            shaped not just my journey, but my mindset – bold, fearless, and focused on transformation. This is not just
            about me; it's about how ideas, experiences, and courage can redefine the future.
          </p>
        ...
        <div className={`flex flex-col ${isLargeScreen ? 'lg:flex-row' : ''} gap-16 mb-24`}>
          ...
          <div className={`w-full ${isLargeScreen ? 'lg:w-1/2' : ''}`}>
            <h2 className="text-4xl font-bold mb-12 leading-tight text-[#ffff33]">The Bold Beginning</h2>
            ...
            <div className="flex flex-col gap-8">
              ...
              <p className="text-gray-400 mb-16 text-lg leading-relaxed">
                The future belongs to those who dare to create it. My mission is simple – push boundaries, inspire change, and empower others through innovation and leadership. Whether it's education, automation, or entrepreneurship, my focus is clear: build a bold, creative, and sustainable future.
              </p>
