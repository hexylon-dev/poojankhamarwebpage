  ...
  const achievements = [
    {
      ...
      description:
        "Reduced stock wastage by 30% and optimized supply chain operations.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Enabled the company to prevent equipment breakdowns, saving over $1 million annually.",
      icon: <Sparkles className="w-8 h-8 text-[#003366]" />,
    },
    {
      title: "Fraud Detection System for a Leading Fintech Company",
      description:
        "Decreased fraudulent activities by 40%, enhancing customer trust.",
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "Improved patient engagement and care delivery for a large healthcare provider.",
      icon: <Sparkles className="w-8 h-8 text-[#003366]" />,
    },
  ];
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-lg max-w-2xl mx-auto text-center mb-12 text-gray-600">
          At Hexylon Analytics, we leverage cutting-edge AI technologies to
          deliver transformative solutions across diverse industries. Here are
